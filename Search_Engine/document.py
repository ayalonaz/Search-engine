...
class Document:
    def __init__(self, tweet_id, tweet_date=None, full_text=None, url=None, retweet_text=None, retweet_url=None,
                 quote_text=None, quote_url=None, term_doc_dictionary=None, entities_doc_dictionary=None, doc_length=None, length_of_uniqe_term=None, length_of_all_terms=None, max_word=None, max_term_appearance=None):
        """
